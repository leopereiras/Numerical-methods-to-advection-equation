function [y4] = laxwendroff(deltaT,tempo,aux,deltaX,cinj,cini,newVet,oldVet,u,divEspaco,vetorEspaco,deltaTMAX)
tic
...
title("Equação de Advecção-Difusão LAXWENDROFF");
grid on
hold on
